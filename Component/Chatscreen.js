...
export default class Chatscreen extends Component {
  ...
  async componentDidMount() {
    ...
    firestore()
      ...
      .doc(phonenumber)
      .collection('Chatroom')
      .doc(this.props.route.params.title._id)
      .collection('Message')
    ...
    setTimeout(() => {
      firestore()
        .collection('Mediator')
        .doc(this.props.route.params.title.phonenumber)
        .collection('Chatroom')
        .onSnapshot((querySnapshot) => {
      ...
      <View
        ...
        <View style={{flexDirection: 'row'}}>
          ...
          <Text
            ...
            Your chat is end to end encrypted. Remember to be cautious about
      ...
      <View style={{flex: 1, backgroundColor: backgroundcolor}}>
          ...
          <TouchableHighlight
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <Backicon
                name="arrowleft"
                size={(widthsize * 5) / 100}
                color={highlightcolor}></Backicon>
              {this.props.route.params.title.smallimage == 'No Photo' ? (
                <View
                  style={{
                    alignItems: 'center',
                    justifyContent: 'center',
                    width: (widthsize * 9) / 100,
                    height: (widthsize * 9) / 100,
                    borderRadius: (widthsize * 9) / 100 / 2,
                ...
                <Image
                  source={{uri: this.props.route.params.title.smallimage}}
        ...
        <ImageBackground
          ...
          <GiftedChat
            ...
            renderFooter={() => {
              return <View style={{height: (heightsize * 4) / 100}} />;
            }}
            renderAvatar={null}
            scrollToBottom
            alwaysShowSend
