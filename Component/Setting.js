...
export default class Setting extends Component {
  ...
  async componentDidMount() {
    ...
    const mediumimage = await AsyncStorage.getItem('mediumimage');
    this.setState({name, phonenumber, mediumimage});
    setTimeout(() => {
    ...
    return (
      <View style={{flex: 1, backgroundColor: backgroundcolor}}>
        ...
        {this.state.Showindicator == true ? (
          ...
          <View style={{flex: 1, backgroundColor: backgroundcolor}}>
            <View
              ...
              {this.state.mediumimage == 'No Photo' ? (
                <View
                  style={{
                    width: (widthsize * 16) / 100,
                    height: (widthsize * 16) / 100,
                    borderColor: highlightcolor,
                    justifyContent: 'center',
                    borderRadius: (widthsize * 16) / 100 / 2,
                    overflow: 'hidden',
                    borderWidth: 1,
                    alignItems: 'center',
                  }}>
                ...
                <TouchableOpacity
                  ...
                  <Image
                    source={{uri: this.state.mediumimage}}
        ...
        {this.state.logoutalert == true ? (
          <TouchableWithoutFeedback
            onPress={() => this.setState({logoutalert: false})}>
            <View
              style={{
                flex: 1,
                justifyContent: 'center',
